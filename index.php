...
if(isset($_POST['register'])){
  ...
  if(!filter_var($email,FILTER_VALIDATE_EMAIL)){
   ...
   if($select_user->rowCount() > 0){
      ...
      if($pass!=$cpass){
         $repassworderror="error repassword";
         echo $repassworderror."<br>";
         }
      if($pass != $cpass){
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>ACTION</span>PIZZA</a>
   ...
   <section>
      ...
      <div class="flex">
         ...
         <form action="user_login.php" method="post">
            ...
            <h3>register now</h3>
            <input type="text" name="name" oninput="this.value = this.value.replace(/\s/g, '')" required class="box" placeholder="enter your username" maxlength="20"><?php if(isset($nameerror)) echo $nameerror;?>
            <input type="email" name="email" required class="box" placeholder="enter your email" maxlength="50"><?php if(isset($emailerror)) echo $emailerror;?>
            ...
            <input type="password" name="cpass" required class="box" placeholder="confirm your password" maxlength="20" oninput="this.value = this.value.replace(/\s/g, '')"><?php if(isset($repassworderror)) echo $repassworderror;?>
            <input type="number"  class="box" name="age" placeholder="enter your age" max="80" min="1"   >
      <div>
      ...
      <input type="number" name=number  placeholder="enter your phone" required class="box" >
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Everything we do is made with love and energy, including cleanliness and precision and we love </p>
      ...
      <div class="box">
         ...
         <p>Contact us within 24 hours and we will be there in 30 minutes to deliver it, we are fast</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Do not forget to support us, publish our name, and share with friends all your happy moments</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
   ...
   <div class="accordion-container">
      ...
      <div class="accordion active">
         ...
         <p class="accrodion-content">
            we works through 24 h with very quilaty 
      </p>
      </div>
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>where your restaurant ?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
             in syria-damas-massa plaza
      </p>
      </div>

      <div class="accordion">
         <div class="accordion-heading">
            <span>how much cheff number  ?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
we have more than 10 cheffs
      </p>
      </div>
      ...
      <div class="accordion">
         ...
         <p class="accrodion-content">
      yes, but  within specific criteria     
      </p>
      </div>
...
<section class="footer">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>our address</h3>
         <p>damascuss-massa plaza - 400104</p>
      </div>
      ...
      <div class="box">
         ...
         <h3>email address</h3>
         <p>action@gmail.com</p>
         <p>pizzaresturant@gmail.com</p>
      </div>

   </div>

   <div class="credit">
      &copy; copyright @ <?= date('Y'); ?> by <span>action_pizza</span> | all rights reserved!
   </div>
